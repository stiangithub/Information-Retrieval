...
public class HW4 {
	...
	Scanner queryScan = new Scanner(new File("./queries.txt"));
	while (queryScan.hasNextLine()) {
	    ...
	    try {
            ...
            String filename = "task1query" + ++queryId + ".txt";
            PrintWriter pw = new PrintWriter(new FileWriter(filename));
            for (int i = 0; i < hits.length; ++i) {
                int docId = hits[i].doc;
                Document d = searcher.doc(docId);
                System.out.println((i + 1) + " " + d.get("path").substring(39)
                        + " score=" + hits[i].score);
                pw.write((i + 1) + " " + d.get("path").substring(39)
                        + " score=" + hits[i].score + "\n");
...
//result:  /Users/wangluqi/desktop/ir/hw04/index
//corpus:  /Users/wangluqi/Desktop/IR/Project/cacm
